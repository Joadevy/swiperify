          ...
          <div className="p-4 rounded m-4">
            ...
            <p className="mt-2 mb-4 text-base">
              We can do this for you if you <span className=' text-accent-light'>
                click the procced button</span> and then please close the tab
              to continue using this app.
            </p>

            <footer className='flex text-base justify-between'>
              <button onClick={logout} className="px-2 py-1 bg-accent-light text-zinc-800 rounded-sm hover:scale-105 hover:cursor-pointer transition-all hover:opacity-85'">
                Proceed
              </button>

...
export const SwipePlaybackLoading = () => {
  return (
                <div className='drop-shadow-2xl relative p-3 w-[325px] lg:w-[400px] h-[415px] lg:h-[425px] flex flex-col gap-1 items-center justify-center rounded-sm overflow-hidden bg-zinc-900 border border-zinc-800 animate-pulse'>
                  <article className='flex flex-col w-full absolute top-0 border border-zinc-600 rounded-md overflow-hidden shadow-xl ' >
                      <div className='w-full h-[325px] lg:h-[415px] relative bg-zinc-700'/>
